...
**GWIPS returns 403**: GWIPS may block external URLs. Contact your GWIPS admin to whitelist the server IP.

**UCSC can't load tracks**: Check Apache CORS:
```bash
curl -I http://localhost/genomebrowsertrack/
```
